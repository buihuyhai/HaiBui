...
while True:
    ...
    if ns == "20/10/2022":
        print("Chính Xác !!! Chúc mừng ngày phụ nữ Việt Nam! Chúc cô Xuân cùng các bạn nữ lớp mình luôn luôn xinh đẹp, gặp nhiều may mắn và đạt được mọi mong muốn ")
        print("Chúc cô Xuân luôn giữ mãi vẻ đẹp tuổi 16 cũng như sự nhiệt tình tuyệt vời của mình trong những bài giảng")
        print("Chúc các bạn nữ luôn duyên dáng, mĩ miều, ngày càng xinh đẹp, học giỏi và đặc biệt hơn là luôn luôn ở trạng thái tuyệt vời nhất trong đôi mắt của nửa còn lại")
        time.sleep(1)
