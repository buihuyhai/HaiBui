...
while True:
    ...
    if ns == "20/10/2022":
        ...
        print("Trong mùa thu hiền dịu, êm đềm đó chúng ta không khỏi bồi hồi, xúc động hướng đến cái riêng của mỗi chúng ta và là cái chung của cả đất nước, Kỷ niệm ngày  thành lập Hội liên hiệp Phụ nữ Việt Nam (20/10/1930 – 20/10/2022), ngày mà cả đất nước Việt Nam dành để tôn vinh người phụ nữ về những thiên chức cao quý.")
        ...
        print("Lê-nin có nói:Vật chất quyết định ý thức tuy nhiên điều đó chưa chắc hoàn  toàn đúng đối với các cô gái Việt Nam, đâu nhất thiết phải là của cải tiền bạc,  đâu nhất thiết phải là gấm son lụa là, đôi khi chỉ là lời chúc, lời khen cũng đã quyết định được một điều gì đó trong ý thức của người phụ nữ Việt Nam.")
